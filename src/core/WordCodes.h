...
#define OP_SPRITETEXT			OPTYPE_NONE + 0x00013a
#define OP_PRINTAT				OPTYPE_NONE + 0x00013b
#define OP_MAXIMIZE				OPTYPE_NONE + 0x00013c
...
#define OP_ONSTOPCALL   		OPTYPE_LABEL + 0x00000d
